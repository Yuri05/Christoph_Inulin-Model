# Inulin-Model
Whole-body PBPK model of inulin in rats [1].
...
**The latest release of the snapshot of the model, the evaluation plan and the static content can be found [here](https://github.com/Open-Systems-Pharmacology/Inulin-Model/releases/latest).**
